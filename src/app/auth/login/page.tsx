      ...
      <Section tone="surface" size="lg" className="pt-32">
        <div className="max-w-md mx-auto">
          ...
          <form onSubmit={submit} className="mt-8 space-y-4 rounded-3xl border border-border bg-background p-6">
            ...
            <CTAButton type="submit" size="lg" className="w-full hover:bg-primary">Sign in</CTAButton>
            <p className="text-sm text-muted-foreground text-center">
              New here? <Link href="/auth/signup" className="text-foreground underline underline-offset-4">Create an account</Link>
            </p>
