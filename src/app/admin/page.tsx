        ...
        <div key={o.id} className="rounded-2xl border border-border p-5">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div className="max-w-xl">
              <p className="font-bold">{o.title} <span className="text-sm text-muted-foreground">· Rs {o.amount?.toLocaleString()}</span></p>
              ...
              {o.paymentScreenshot && (
                <div className="mt-3">
                  ...
                  <img src={o.paymentScreenshot} alt="proof" className="mt-2 h-32 object-contain rounded-md border" />
                </div>
              )}
            </div>
            <div className="flex flex-col items-end gap-2">
              ...
              {!o.paymentConfirmed && (
                <button onClick={() => orderActions.confirmPayment(o.id)} className="text-sm bg-foreground text-background px-3 py-1 rounded-full">Confirm payment</button>
              )}
              {!o.delivered && (
                <button onClick={() => orderActions.markDelivered(o.id)} className="text-sm bg-primary text-background px-3 py-1 rounded-full">Mark delivered</button>
              )}
