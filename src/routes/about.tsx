...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About — NepaKanvas" },
      { name: "description", content: "Our story, mission and the artists behind every NepaKanvas painting." },
      { property: "og:title", content: "About — NepaKanvas" },
...
const ARTISTS = [
  { name: "Sushant K.", role: "Founder & Lead Portrait Artist", image: ASSETS.artistHolding },
  { name: "Mira T.", role: "Wall & Mural Specialist", image: ASSETS.fourFace },
  { name: "Ayan R.", role: "Live Event Painter", image: ASSETS.portraitBalen },
];
        ...
        <div className="grid md:grid-cols-2 gap-10 md:gap-20 items-center">
          <Reveal>
            <div className="aspect-[4/5] rounded-3xl overflow-hidden bg-secondary">
              <img src={ASSETS.fourFace} alt="Studio work" loading="lazy" className="h-full w-full object-cover"/>
            </div>
          </Reveal>
          <Reveal delay={0.1}>
      ...
      <Section tone="dark">
        <Reveal>
          <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-8">
            ...
            <CTALink to="/contact" size="lg" withArrow className="bg-background text-foreground border-background hover:bg-transparent hover:text-background">Get in touch</CTALink>
          </div>
        </Reveal>
      </Section>
    </SiteShell>
