...
export const Route = createFileRoute("/classes")({
  head: () => ({
    meta: [
      { title: "Art Classes — NepaKanvas" },
      { name: "description", content: "Learn drawing, sketching, painting and portraiture from professional Nepali artists. Kids, beginner, intermediate and advanced." },
      { property: "og:title", content: "Art Classes — NepaKanvas" },
    ...
    <SiteShell>
          ...
          {COURSES.map((c) => (
            <motion.article key={c.title} variants={fadeUp}
              ...
              <div className="mt-8 pt-6 border-t border-border flex items-end justify-between gap-4">
                ...
                <CTALink to="/contact" withArrow>Enroll</CTALink>
              </div>
            </motion.article>
          ))}
        </motion.div>
      ...
      <Section tone="surface">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-5">
          {[ASSETS.portraitGirl, ASSETS.buddha, ASSETS.portraitRonaldo, ASSETS.fourFace, ASSETS.portraitBalen, ASSETS.artistHolding, ASSETS.portraitGirl, ASSETS.buddha].map((src, i) => (
